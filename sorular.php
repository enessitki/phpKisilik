...
<body>
    ...
    ?>
        ...
        <div class="row">
            <div class="tm-intro">
                <div class="col-sm-12 col-md-8 mb-md-0 mb-4 tm-intro-left">
                    <p class="mb-0">Bu kişilik testi gerçek değildir.Ticari amaçla kullanılmamıştır. <a href="http://www.testler.org/test.php?test=16">Site - 1</a> ve
        ...
        <div class="row">
          <div class="col-12">
                <footer>
                    <p class="text-center mb-3 tm-footer-text">Copyright &copy; 2020 Enes Sıtkı </p>
                </footer>
            </div>
        </div>
    </div>
