...
<head>
  <meta charset="utf-8">
  <title>Kişilik Testi - Enes Sıtkı</title>
        ...
        <div class="row">
          <div class="col-lg-6">
            ...
            <p>Bu kişilik testi gerçek değildir.Sorular ve sonuçlar aşağıda vermiş olduğum sitelerden kopyalanarak hazırlanmıştır. 
              Kendimi geliştirme amaçlı yaptığım bir uygulamadır. Ticari amaçla kullanılmamıştır.
...
Warren Buffett</p>
        ...
        <div class="row contact-info">
          ...
          <div class="col-md-4">
            <div class="contact-address">
              ...
              <p><a href="https://twitter.com/enessitki">twitter.com/enessitki</a></p>
            </div>
          </div>
          ...
          <div class="col-md-4">
            <div class="contact-email">
              ...
              <h3>Email</h3>
              <p><a href="mailto:enessitkii@gmail.com">enessitkii@gmail.com</a></p>
            </div>
          </div>
  ...
  <footer id="footer">
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 footer-info">
            ...
            <p>Bu kişilik testi gerçek değildir.Sorular ve sonuçlar aşağıda vermiş olduğum sitelerden kopyalanarak hazırlanmıştır. Ticari amaçla kullanılmamıştır.</p>
          </div>
          ...
          <div class="col-lg-3 col-md-6 footer-contact">
            ...
            <div class="social-links">
              <a href="https://twitter.com/enes.sitki" class="twitter"><i class="fa fa-twitter"></i></a>
              <a href="https://facebook.com/enessitki" class="facebook"><i class="fa fa-facebook"></i></a>
              <a href="https://instagram.com/enes.sitki" class="instagram"><i class="fa fa-instagram"></i></a>            
              <a href="https://www.linkedin.com/in/enessitki/" class="linkedin"><i class="fa fa-linkedin"></i></a>
            </div>
    ...
    <div class="container">
      <div class="copyright">
        &copy; Copyright <strong>Enes Sıtkı</strong>
      </div>
      <div class="credits">
               Designed by Enes</a>
      </div>
